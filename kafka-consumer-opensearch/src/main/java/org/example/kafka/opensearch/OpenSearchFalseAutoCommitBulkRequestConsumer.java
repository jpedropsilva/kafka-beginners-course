...
public class OpenSearchFalseAutoCommitBulkRequestConsumer {

    private static final Logger logger = LoggerFactory.getLogger(OpenSearchFalseAutoCommitBulkRequestConsumer.class);
